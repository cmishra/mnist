...
model.add_node(test_submission, name='path1', input='50_dims')
model.add_node(Identity(),
          name='path2', input='50_dims')
model.add_node(Activation('relu'), inputs=['path1', 'path2'], merge_mode='sum',
               name='recombine')
...
model_save_dir = '../saved_models/ResNet_Test/'
...
file_path = '../data/assess_resnetSimple.txt'
